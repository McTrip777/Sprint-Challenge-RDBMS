...
I don't think he ever taught us what RDBMS is but google says its a relational database management system. And it is the basis for sql. sql is just used to interact with the DBMS.

1. Why do tables need a `primary key`?

So that when the information is needed you can I dentify it clearly.
...
a third table that will go one to many with each.
